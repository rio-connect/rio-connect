  ...
  <Container className="pt-5 d-flex justify-content-center">
    <Row>
      ...
      <div>
        ...
        <h1>Welcome to Rio-Connect</h1>
        <p>Rio-Connect is the ultimate app for college students looking to discover new clubs and organizations on their university campus!
        </p>
        <p>
